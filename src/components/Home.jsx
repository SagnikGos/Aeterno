      ...
      <div className="relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-green-200 max-w-3xl mx-auto mb-8">
            Bridging the gap between sustainable recycling and artistic
            innovation. Empower artisans while reducing environmental impact.
          </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-bold text-center mb-12 text-green-50">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2 text-green-50">
                  {step.title}
                </h3>
